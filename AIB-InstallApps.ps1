<#
Script purpose: Download and Install common Applications
Version: 1.0
Date: 18-01-2022
...
#region AZCopy
$url="https://azcopyvnext.azureedge.net/release20211027/azcopy_windows_amd64_10.13.0.zip"
$output=$TempPath+"\azcopy.zip"
(New-Object System.Net.WebClient).DownloadFile($url, $Output)
Expand-Archive -Path $output -DestinationPath $TempPath
